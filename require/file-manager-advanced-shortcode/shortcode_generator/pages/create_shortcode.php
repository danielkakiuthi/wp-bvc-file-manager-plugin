<?php if ( ! defined( 'ABSPATH' ) ) {
 ...
 <h3>Create Shortcode <a href="<?php echo admin_url('admin.php?page=file_manager_advanced_shortcode_generator');?>" class="button button-primary">Shortcodes</a></h3>
 <?php if(isset($_POST['submit'])):
    fma_shortcode_generator::generateShortcode();
  endif; ?>	
 <form action="<?php echo admin_url('admin.php?page=fma_shortcode_create');?>" method="post" name="afm-shortcode-generator" id="afm-shortcode-generator" class="afmshortcodegenerator">
 <?php wp_nonce_field( 'fma_create_nonce', 'fma_create_nonce_field' ); ?>
<table class="form-table">
<tbody>
<tr>
<th>Shortcode Title*</th>
<td>
<input type="text" name="shortcode_title" id="shortcode_title" class="regular-text" value="" placeholder="Enter shortcode title*" required />
<div>
...
<select name="login" id="login">
	<option value="1" selected="selected">Logged In Users</option>
	<option value="0">Non Logged In Users (Site visitors)</option>
</select>
<p class="description">Select to generate shortcode for logged in or non logged in users.</p>
</td>
</tr>
...
<?php } ?>
<p class="description">Only selected user roles can access file manager. Default: All. Please note this option will work with Shortcode Type "Logged In Users" </p>
</td>
</tr>
...
<th>Path*</th>
<td>
<input name="path" type="text" id="path" value="" placeholder="Enter folder path or allowed symbols like % or $" class="regular-text" required />
...
(2) <strong>%</strong> - Use % to assign root directory<br/>
(3) <strong>$</strong> - $ will generate personal/private folder for users with their username (unique) under location "wp-content/uploads/file-manager-advanced/users".<br/>
(4) <code>wp-content/uploads/file-manager-advanced/users</code> - You can view and access all user's personal/private folders under mentioned path.</p>
</td>
</tr>
...
<p class="description">This option will only work with Path Type "Outside".</p>
</td>
</tr>
...
<th>Hide</th>
<td>
<input name="hide" type="text" id="hide" value="" class="regular-text">
...
<td>
<input type="checkbox" value="<?php echo $key; ?>" name="operations[]"><?php echo $operation; ?>
</td>
<?php 
...
<th>Block Users</th>
<td>
<input name="block_users" type="text" id="block_users" value="" class="regular-text">
...
<p class="description">Select file manager advanced language. Default: en (English)</p>
</td>
</tr>
...
<th>Date Format*</th>
<td>
<input name="dateformat" type="text" id="dateformat" value="M d, Y h:i A" class="regular-text" required />
...
<th>Height</th>
<td>
<input type="text" name="height" id="height" class="regular-text" value="">
<div>
...
<th>Width</th>
<td>
<input type="text" name="width" id="width" class="regular-text" value="">
<div>
...
<td>
	<?php foreach($ui as $uii):?>
      <input type="checkbox" value="<?php echo $uii;?>" name="display_ui_options[]" checked="checked"> <?php echo $uii;?> <br>
    <?php endforeach;?>
...
<td>
<input type="text" name="upload_max_size" id="upload_max_size" class="regular-text" value="0" required />
<div>
<p>
...
<td>
<textarea name="upload_allow" id="upload_allow" class="large-text" rows="3" cols="30" required />all</textarea>	
